<template>
  <section class="hero-section hero-six ptb-120 bg-dark text-white">
    <div class="container">
        ...
        <div class="col-xl-5 col-lg-5">
          ...
          >
            ...
            >
              ...
              <ul
                class="nav subscribe-feature-list mt-3 justify-content-lg-start justify-content-md-center"
              >
                <li class="nav-item">
                  <span class="ms-0"
