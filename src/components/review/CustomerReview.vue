  ...
  <section class="sh-feedback pt-120 game-bg-dark">
    <div class="container position-relative">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-8 col-md-4">
          <div class="text-md-end">
            <router-link to="/about-us" class="game-btn-mdm text-white">
              More Feedback
            </router-link>
          </div>
        </div>
      ...
      <div class="position-relative pt-80">
        <div class="game-cta-bg rounded-top px-4 px-md-0 ps-md-5 pt-80">
          <div class="row">
            <div class="col-lg-5 col-md-8">
              <div class="game-cta-content">
                ...
                <router-link to="/contact" class="game-btn-mdm mt-4 text-white"
