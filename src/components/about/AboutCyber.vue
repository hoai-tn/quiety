          ...
          <div class="cyber-about-img text-center mb-30 mb-lg-0">
            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="pe-2">
                  <div
                    class="cyber-about-count-box d-md-flex bg-white p-4 mt-3"
                  >
                    <div class="pe-3">
                      <h2>20+</h2>
                    </div>
        ...
        <div class="col-lg-6">
          <div class="pt-5">
            <div class="section-heading mb-5">
              <h5 class="h6 text-primary">About Quiety</h5>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="bg-white cyber-about-box mb-30 mb-lg-0">
              ...
              <div class="col-lg-6">
                <div class="bg-white cyber-about-box">
                  <div class="cyber-about-icon">
