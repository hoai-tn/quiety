<template>
  <div class="testimonial-tab-slider-wrap mt-5">
    ...
    <p>
      Whatever your goal or project size we will handel it utilize standards
      compliant. We hope you will be 100% satisfied.
    </p>
    <hr />
    <div
    ...
    >
      ...
      >
        <blockquote class="blockquote">
          <em
            >"Globally actualize economically sound alignments before tactical
            systems. Rapidiously actualize processes technically sound
            infomediaries. Holisticly pursue team building catalysts for change
            before team driven products. "</em
          >
        </blockquote>
      ...
      <div class="tab-pane fade" id="testimonial-tab-2" role="tabpanel">
        <blockquote class="blockquote">
          <em
            >"Synergistically evisculate market positioning technology vis-a-vis
            team driven innovation. Phosfluorescently morph tactical communities
            for superior applications. Distinctively pontificate
            resource-leveling infomediaries and parallel models. "</em
          >
        </blockquote>
        <div class="author-info mt-3">
      ...
      <div class="tab-pane fade" id="testimonial-tab-3" role="tabpanel">
        <blockquote class="blockquote">
          <em
            ...
            interactive opportunities through parallel innovation. "</em
          >
        </blockquote>
        <div class="author-info mt-3">
