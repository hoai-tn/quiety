<template>
  <section class="cyber-store-product">
    <div class="store-bg-header">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6">
            <div class="section-heading text-center mb-5">
              <h5 class="h6 text-primary">Online Store</h5>
              <h2 class>Our popular Cyber security products</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row product-row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="single-product position-relative mb-30">
            ...
            <span class="bg-primary text-white px-2 rounded sale-badge"
              >Sale!</span
            >
            <div class="product-cart-wishlist-icon">
              <div class="cart">
