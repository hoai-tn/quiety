      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 col-md-4 d-none d-md-block d-lg-block">
          <div class="support-article-sidebar sticky-sidebar">
            <a
              ...
              ><i class="far fa-angle-left me-2"></i> Go Back</a
            >
            <div
            ...
            >
              ...
              <router-link
                ...
                >Can retailers opt-out of participation at any
                time?</router-link
              >
              <router-link
                to="/helps"
                class="text-muted text-decoration-none py-2 d-block"
                >How long does enforcement take after a MAP violation attempt is
                made?</router-link
              >
              <router-link
                to="/helps"
                ...
                enforcement to occur?</router-link
              >
              <router-link
                to="/helps"
                class="text-muted text-decoration-none py-2 d-block"
                >What is the monthly cost of your app?</router-link
              >
              <router-link
                to="/helps"
                class="text-muted text-decoration-none py-2 d-block"
                >Do you offer refunds for the subscriptions?</router-link
              >
              <router-link
                to="/helps"
                class="text-muted text-decoration-none py-2 d-block"
                >Are notifications sent when MAP violation attempts
                occur?</router-link
              >
            </div>
        ...
        <div class="col-lg-8 col-md-8 p-lg-5">
          <div class="support-article-wrap">
            ...
            <p>
              Dramatically plagiarize client-based relationships and interactive
              supply chains. Interactively enable leading-edge outsourcing
              without interoperable sources. Compellingly fabricate
              multifunctional mindshare with prospective e-business.
            ...
            <p>
              ...
              Compellingly transition worldwide strategic theme areas vis-a-vis
            ...
            <p>
              ...
              functionalities. Phosfluorescently benchmark an expanded array of
              data for premier interfaces.
            </p>
          </div>
        </div>
      </div>
