      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="text-center mb-5">
            <h2 class="mb-3 text-white">Our Most Common Question.</h2>
            <p class="m-0 text-off-white">
              Whether hosting community forums, an online store, or even a blog,
              this platform is built to meet and surpass expectations.
            </p>
          </div>
        </div>
      </div>
                ...
                >
                  <div class="accordion-body">
                    <p class="text-off-white m-0">
                      Multiple layers of security firewalls ensure the safety of
                      our entire web hosting environment. Thanks to the
