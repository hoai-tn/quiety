    ...
    <div class="container">
      <div class="row align-items-center justify-content-lg-between">
          ...
          <div class="app-two-feature-three-left">
            <div class="app-content-feature-wrap">
              ...
              <p>
                ...
                dodgy chav you mug. Energistically conceptualize scalable
            ...
            <div class="accordion faq-accordion mt-5" id="accordionExample">
              <div class="accordion-item active border-0">
                ...
                <div
                  id="collapse-1"
                  class="accordioncollapse collapse show"
              ...
              <div class="accordion-item border-0">
                <h5 class="accordion-header" id="faq-2">
                  <button
                    ...
                    aria-expanded="false"
                  >
                    <i class="far fa-command pe-3"></i>Can you show me an
                    example?
                  </button>
                </h5>
                <div
              ...
              <div class="accordion-item border-0">
                <h5 class="accordion-header" id="faq-3">
                  <button
                    ...
                    aria-expanded="false"
                  >
                    <i class="fas fa-link pe-3"></i>How do I processing I need?
                  </button>
                </h5>
                <div
                  id="collapse-3"
        ...
        <div class="col-lg-6 col-xl-6 col-sm-12">
          <div
            class="app-two-feature-three-img position-relative text-center mt-5 mt-lg-0"
          >
