      ...
      <div class="row align-items-lg-center justify-content-between">
          ...
          >
            <li>
              <span class="d-block mb-4"
                ><i class="fal fa-fingerprint fa-2x text-primary"></i
              ></span>
            ...
            <li>
              <span class="d-block mb-4"
                ><i class="fal fa-shield-check fa-2x text-primary"></i
              ></span>
        ...
        <div class="col-lg-6">
          <div class="pr-lg-4 position-relative" data-aos="fade-up">
            ...
            <!--animated shape end-->
            <div
              class="bg-light text-center shadow-sm rounded-custom overflow-hidden pt-5 px-3 px-lg-5 mx-lg-auto"
            >
              <div class="mb-5">
